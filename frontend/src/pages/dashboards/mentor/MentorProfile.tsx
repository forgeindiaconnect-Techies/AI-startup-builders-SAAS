...
const MentorProfile: React.FC = () => {
  const [form, setForm] = useState({
    ...
    bio: 'Ex-VC and serial entrepreneur. Passionate about helping early-stage SaaS and FinTech founders find product-market fit and scale.',
    expertise: 'SaaS, Go-to-Market, Fundraising',
    ...
    <div className="animate-fade-in-up pb-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage your public mentor profile visible to founders.</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col items-center text-center">
          <div className="relative mb-4">
            <div className="w-28 h-28 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-4xl font-black shadow-xl">
              A
            </div>
            <input 
              type="file" 
              ...
              onChange={(e) => {
                if(e.target.files && e.target.files[0]) {
                  window.alert(`Simulating upload of ${e.target.files[0].name}...`);
                }
              }}
            />
            <button 
          ...
          <p className="text-sm text-blue-600 font-bold uppercase tracking-widest mt-1">Mentor</p>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                { label: 'Expertise (comma separated)', key: 'expertise', type: 'text' },
