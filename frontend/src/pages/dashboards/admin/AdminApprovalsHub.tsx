  ...
  return (
    <div className="animate-fade-in-up">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Review and approve mentor applications and investor KYC accreditations.</p>
      </div>
      ...
      <div className="flex gap-1 bg-gray-100 rounded-xl p-1 mb-7 w-fit flex-wrap">
        {tabs.map(t => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold whitespace-nowrap transition-all duration-200 cursor-pointer ${
