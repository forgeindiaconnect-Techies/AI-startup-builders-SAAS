  ...
  founder: [
    {
      items: [
        ...
        { name: 'Inbox',            icon: Inbox,           path: '/dashboard/founder/inbox' },
  ...
  mentor: [
    {
      items: [
        ...
        { name: 'Inbox',             icon: Inbox,          path: '/dashboard/mentor/inbox' },
  ...
  investor: [
    {
      items: [
        ...
        { name: 'Inbox',              icon: Inbox,           path: '/dashboard/investor/inbox' },
  ...
  admin: [
    {
      items: [
        ...
        { name: 'Inbox',                   icon: Inbox,           path: '/dashboard/admin/inbox' },
      ],
    },
  ],
};
