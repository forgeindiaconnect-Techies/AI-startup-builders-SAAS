...
export const DEFAULT_APPROVED_INVESTORS = [
  {
    id: 'inv_1',
    name: 'Rakesh Sharma',
    email: 'rakesh@investor.com',
    companyName: 'Nexus Venture Partners',
    designation: 'Managing Partner',
    investorType: 'Investment Firm / VC',
    experienceYears: '12+ years',
    location: 'Bengaluru, Karnataka',
    linkedinUrl: 'https://linkedin.com/in/rakesh-sharma-investor',
    website: 'https://nexusvp.com',
    bio: 'Active venture partner focusing on early-stage AI copilots, B2B SaaS, and high-growth fintech platforms with strong unit economics.',
    preferredIndustries: ['Artificial Intelligence', 'SaaS', 'FinTech'],
    investmentStages: ['Seed', 'Series A'],
    investmentRange: '₹25 Lakhs – ₹1 Crore',
    investmentFocus: 'Proprietary technology stack, strong founder-market fit, scalable ARR model, and rapid user acquisition.',
    portfolioCompanies: 'CloudScale AI, DataPulse, PayFlow, HealthSync',
    notableInvestments: 'Lead Seed in CloudScale AI ($2M), Series A in PayFlow',
    areasOfExpertise: 'GTM Strategy, SaaS Scaling, Series A Fundraising',
  ...
  },
  {
    ...
    website: 'https://nambiarfamily.in',
    bio: 'Managing strategic family office capital allocation for early and growth-stage technology ventures across India and Southeast Asia.',
    preferredIndustries: ['DeepTech', 'HealthTech', 'Artificial Intelligence'],
    investmentStages: ['Pre-Seed', 'Seed'],
    investmentRange: '₹1 Crore – ₹5 Crores',
    investmentFocus: 'Deep tech innovations, IP-protected AI healthcare solutions, and high-margin B2B enterprises.',
    portfolioCompanies: 'CareConnect, BioGen AI, MedPulse, QuantumLeap',
    notableInvestments: 'Pre-Seed Lead in BioGen AI, Seed in CareConnect',
    areasOfExpertise: 'Corporate Governance, DeepTech Advisory, Cross-border Expansion',
    verificationStatus: 'APPROVED',
    avatar: 'P',
  },
  {
    ...
    email: 'vikram@singhaniaangels.com',
    companyName: 'Singhania Angels Syndicate',
    designation: 'Angel Investor & Advisor',
    investorType: 'Angel Investor',
    experienceYears: '8+ years',
    location: 'Gurugram, Delhi NCR',
    linkedinUrl: 'https://linkedin.com/in/vikram-singhania',
    website: 'https://singhaniaangels.com',
    bio: 'Ex-VP Product at Unicorn Startup, active angel investor backing passionate founders solving real-world consumer & SaaS challenges.',
    preferredIndustries: ['SaaS', 'EdTech', 'E-commerce', 'FinTech'],
    investmentStages: ['Pre-Seed', 'Seed'],
    investmentRange: '₹5 Lakhs – ₹25 Lakhs',
    investmentFocus: 'High retention, organic product virality, clear GTM playbook, and gritty founding teams.',
    portfolioCompanies: 'EduLabs, QuickCart, OmniDesk, SaaSFlow',
    notableInvestments: 'Angel check in EduLabs ($250k), Early Backer in QuickCart',
    areasOfExpertise: 'Product Strategy, Growth Marketing, Angel Syndicates',
    verificationStatus: 'APPROVED',
    avatar: 'V',
  },
  {
    ...
    email: 'rajesh@peakxv-alum.vc',
    companyName: 'PeakXV Alum Syndicate',
    designation: 'General Partner',
    investorType: 'Micro VC',
    experienceYears: '10+ years',
    location: 'Hyderabad, Telangana',
    linkedinUrl: 'https://linkedin.com/in/dr-rajesh-verma',
    website: 'https://peakxvalum.vc',
    bio: 'Tech-focused investor specializing in generative AI, automated decision systems, and financial tech infrastructure.',
    preferredIndustries: ['Artificial Intelligence', 'FinTech', 'DeepTech'],
    investmentStages: ['Seed', 'Series A'],
    investmentRange: '₹1 Crore – ₹5 Crores',
    investmentFocus: 'Defensible AI moats, enterprise contract pipelines, and strong technical leadership.',
    portfolioCompanies: 'FinMatrix, AI Core, AlgoTrade, NeuralNet',
    notableInvestments: 'Series A Co-lead in FinMatrix ($5M)',
    areasOfExpertise: 'AI Architecture, Enterprise Sales, Series A Advisory',
    verificationStatus: 'APPROVED',
    avatar: 'R',
  },
  {
    id: 'inv_5',
    name: 'Neha Agarwal',
    email: 'neha@blume-angels.in',
    companyName: 'Blume Angels Network',
    designation: 'Principal Investor',
    investorType: 'Individual Investor',
    experienceYears: '7+ years',
    location: 'Bengaluru, Karnataka',
    linkedinUrl: 'https://linkedin.com/in/neha-agarwal-investor',
    website: 'https://blumeangels.in',
    bio: 'Strategic angel investor passionate about developer tools, AI productivity platforms, and B2B SaaS solutions.',
    preferredIndustries: ['Artificial Intelligence', 'SaaS', 'EdTech'],
    investmentStages: ['Pre-Seed', 'Seed'],
    investmentRange: '₹25 Lakhs – ₹1 Crore',
    investmentFocus: 'Product-led growth, low CAC, developer adoption, and strong technical moats.',
    portfolioCompanies: 'DevPulse, CodeGen, SkillUp AI',
    notableInvestments: 'First cheque in DevPulse',
    areasOfExpertise: 'Product-Led Growth, Developer Relations, Seed Syndication',
    verificationStatus: 'APPROVED',
    avatar: 'N',
  }
];
